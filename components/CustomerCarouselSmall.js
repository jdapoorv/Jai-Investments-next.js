...
const customerData = [
  ...
  },
  {
    ...
    review:
      "I'm consistently impressed with their exceptional service.",
  },
  {
    id: 4,
    src: "/img4.jpg",
...
const CustomerCarouselSmall = () => {
  ...
  return (
    <div className="mx-auto my-10 md:hidden">
      <div className="max-w-screen-xl mx-auto flex flex-wrap items-center justify-between">
        {currentCustomers.map((customer, index) => (
          <>
            <div key={customer.id} className="w-6/12 pt-10 px-4 dark:text-white">
              {/* Testimonial content */}
              ...
              <h5 className="mb-2 text-md font-semibold flex items-center justify-center">
                {customer.name}
              </h5>
              ...
              <p className="px-2 text-gray-700 text-center italic text-md dark:text-gray-200">
                " {customer.review} "
              </p>
              {/* Navigation icons */}
            </div>
...
export default CustomerCarouselSmall;
